...
async function runAudit(engine: BrainEngine, args: string[]): Promise<void> {
  ...
  // Mirrors extract-conversation-facts defaults. Email is handled by the
  // real-time fact extractor or thread aggregation, not page-at-a-time bulk
  // conversation backfill.
  const FACTS_BACKFILL_ALLOWED = ['meeting', 'slack'];
